...
<form action='includes/signup.inc.php' method='post'>
        <div style="font-size:20px;color:white; padding:0px; margin:0px;">Singup</div>
        <?php
            if  (isset($_GET["error"])) {
                ...
                echo "<p>please fill all fields</p>";
                    ...
                    echo "<p>wawu you have signed up !</p>";  
                }else {
        ...
        <br>
            <div style="font-size:20px;color:white;padding:0px; margin:0px;">Singup</div>
              ...
              <input type='email' name='email' placeholder='E-mail'><br><br>
                ...
                <button name="submit" value="submit" type="sumbit">Singup</button>
                <br>
